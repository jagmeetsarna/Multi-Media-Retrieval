...
const_cast < char*>("char"), const_cast < char*>("short"), const_cast < char*>("int"),
const_cast < char*>("uchar"), const_cast < char*>("ushort"),const_cast < char*> ("uint"),
const_cast < char*>("float"),const_cast < char*> ("double"),
};
...
void ply_put_comment(PlyFile *plyfile, char *comment)
{
  ...
  if (plyfile->num_comments == 0)
    plyfile->comments = (char **) malloc (sizeof (char *));
  else
...
void ply_put_obj_info(PlyFile *plyfile, char *obj_info)
{
  ...
  if (plyfile->num_obj_info == 0)
    plyfile->obj_info = (char **) malloc (sizeof (char *));
  else
